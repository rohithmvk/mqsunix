...
public class sendMessage {
	...
	public static void main(String[] args){
		...
		try{
			...
			session = m_qConn.createQueueSession(false,javax.jms.Session.AUTO_ACKNOWLEDGE);	
			...
			javax.jms.Message  message = session.createTextMessage();
			 ...
			 if((ReplyToQueueName == "")||(ReplyToQueueName.equalsIgnoreCase(""))){
			...
			System.out.println("Total Time in milliseconds ="+ (stopTime - startTime));
